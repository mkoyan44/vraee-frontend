            ...
            <div className={styles.header} style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <div className="rte" style={{
                        ...
                        <p>Adobe After Effects is our primary tool for motion graphics, visual effects, and video compositing. We utilize its extensive plugin ecosystem, native 3D capabilities, and seamless integration with Adobe Creative Suite to create compelling visual narratives and professional video content.</p>
                    </div>
                </div>
            </div>
            ...
            <div style={{ marginBottom: '4rem' }}>
                ...
                <div style={{
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Advanced text animations, logo reveals, and kinetic typography with expressions and shape layers."
                        category="Animation"
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Rotoscoping, motion tracking, green screen keying, and particle systems for professional compositing."
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Native 3D workspaces with camera tracking, lights, and materials for seamless live-action integration."
                        category="3D"
                    ...
                    <BlenderGalleryCard
                        emoji="🎬"
                        title="Color Grading"
                        description="Professional color correction and LUT development with advanced Lumetri Color panel and curves."
                        category="Color"
                        categoryColor="rgb(var(--color-primary))"
                ...
                <div style={{ textAlign: 'center', marginTop: '3rem' }}>
                    <Link href="/contact" className="btn-simple" style={{
                        ...
                        Start Your After Effects Project
                    </Link>
                </div>
            </div>
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Pre-built compositions with optimized render settings, composition guides, and common animation setups.
                                </p>
                            </div>
                            <Button
                                variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Custom animation presets including bounces, fades, scales, and complex motion paths for quick application.
                                </p>
                            </div>
<Button
    variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Advanced JavaScript expressions for automated animations, responsive layouts, and dynamic effects.
                                </p>
                            </div>
<Button
    variant="outline"
    ...
    Download Guides
                ...
                <div style={{ textAlign: 'center', marginTop: '3rem' }}>
                    <p style={{
                        ...
                        Need custom After Effects resources or have questions about our workflow?
                    </p>
                    <Link href="/contact" className="btn-simple" style={{
                        padding: '0.75rem 2rem',
                        fontSize: '1.1rem',
