            ...
            <div className={styles.header} style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <div className="rte" style={{
                        ...
                        <p>Maxon ZBrush is our premier digital sculpting and texturing solution for organic modeling. Leveraging its powerful brush engine, dynamic tessellation, and intuitive workflow, we create highly detailed 3D models and assets that bring characters and creatures to life with unparalleled anatomical accuracy and surface detail.</p>
                    </div>
                </div>
            </div>
            ...
            <div style={{ marginBottom: '4rem' }}>
                ...
                <div style={{
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Detailed character modeling with anatomy-specific brushes, muscle structure, and facial features for realistic portrayals."
                        category="Sculpting"
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Fantasy and creature sculpting with advanced topology tools, anatomical posing, and complex surface details."
                        category="Design"
                    ...
                    <BlenderGalleryCard
                        ...
                        description="High-frequency detail painting, skin textures, and material properties with polypaint and UV mapping."
                        category="Texturing"
                    ...
                    <BlenderGalleryCard
                        emoji="🔄"
                        title="Dynamic Subdivision"
                        description="Real-time mesh resolution changes with ZRemesher's intelligent retopology and quad-based mesh generation."
                        category="Topology"
                        categoryColor="rgb(var(--color-primary))"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Custom brush sets for anatomy sculpting, texture detailing, and specialized surface manipulation techniques.
                                </p>
                            </div>
                            <Button
                                variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    High-resolution texture maps including skin, fur, scales, and organic surface details for polypainting.
                                </p>
                            </div>
<Button
    variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Anatomical reference models and base meshes for different species and character types to accelerate workflow.
                                </p>
                            </div>
<Button
    variant="outline"
    ...
    Download Guides
                ...
                <div style={{ textAlign: 'center', marginTop: '3rem' }}>
                    <p style={{
                        ...
                        Need custom ZBrush resources or have questions about our sculpting workflow?
                    </p>
                    <Link href="/contact" className="btn-simple" style={{
                        padding: '0.75rem 2rem',
                        fontSize: '1.1rem',
