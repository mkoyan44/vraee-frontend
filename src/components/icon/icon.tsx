...
const Icon: React.FC<IconProps> = ({icon, fill = 'currentColor', className}) => {
    switch (icon){
        case 'arrow_down': {
            return (
        ...
        case 'close': {
            return (
                <svg className={className} clipRule="evenodd" fill={fill} fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
        ...
        case 'plus': {
            return (
                <svg className={className} width="24" height="24" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
