    ...
    const socials = [
        {
            ...
            'url': 'https://www.instagram.com/vraee_/',
        },
        {
            'id': 2,
            'icon': '<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.25 2.3335H15.8333V12.3335C15.8333 14.5918 14.0083 16.4168 11.75 16.4168C9.49167 16.4168 7.66667 14.5918 7.66667 12.3335C7.66667 10.0752 9.49167 8.25016 11.75 8.25016C12.1917 8.25016 12.6083 8.34183 13 8.5085V4.8335C12.6083 4.66683 12.1917 4.5835 11.75 4.5835C8.40833 4.5835 5.66667 7.32516 5.66667 10.6668C5.66667 14.0085 8.40833 16.7502 11.75 16.7502C15.0917 16.7502 17.8333 14.0085 17.8333 10.6668V4.41683C17.8333 3.2585 18.7583 2.3335 19.9167 2.3335C21.075 2.3335 22 3.2585 22 4.41683V10.6668C22 15.5252 18.1083 19.4168 13.25 19.4168C8.39167 19.4168 4.5 15.5252 4.5 10.6668C4.5 5.8085 8.39167 1.91683 13.25 1.91683C13.6917 1.91683 14.1083 2.0085 14.5 2.17516V5.91683C14.1083 5.75016 13.6917 5.66683 13.25 5.66683C10.9917 5.66683 9.16667 7.49183 9.16667 9.75016C9.16667 12.0085 10.9917 13.8335 13.25 13.8335C15.5083 13.8335 17.3333 12.0085 17.3333 9.75016V2.3335H19.25Z" fill="currentColor"/></svg>',
            'url': 'https://www.tiktok.com/@vraee_official',
        },
    ];
    const xmas = new Date();
                    ...
                    <div className={styles.social}>
                        <div className={styles.social_wrapper}>
                            ...
                            <ul className={styles.social_list}>
                                {
                                    socials.map(item => {
                                        const platformName = item.id === 1 ? 'Instagram' : 'TikTok';
                                        return (
                                            <li key={item.id}>
                                                <Link 
                                                    href={item.url} 
