            ...
            <div className={styles.header} style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <div className="rte" style={{
                        ...
                        <p>Matrix is our proprietary VFX and rendering orchestration platform, designed to streamline complex production pipelines. This in-house development tool provides automated asset management, distributed rendering capabilities, and real-time collaboration features that ensure our team delivers projects on time and within scope.</p>
                    </div>
                </div>
            </div>
            ...
            <div style={{ marginBottom: '4rem' }}>
                ...
                <div style={{
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Automated render farm management with intelligent load balancing, resource optimization, and priority-based task scheduling."
                    ...
                    <BlenderGalleryCard
                        ...
                        description="End-to-end asset management with version control, dependency tracking, and automated conversion workflows between applications."
                        category="Management"
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Real-time project monitoring with progress visualization, bottleneck identification, and predictive completion estimates."
                        category="Analytics"
                    ...
                    <BlenderGalleryCard
                        ...
                        description="Integrated review system with notes, annotations, and feedback loops ensuring quality control throughout the production process."
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Pre-configured project structures with standardized workflows, milestone templates, and automated reporting systems.
                                </p>
                            </div>
                            <Button
                                variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Custom scripts for batch processing, file management, and automated quality checks to streamline production workflows.
                                </p>
                            </div>
<Button
    variant="outline"
                        ...
                        <CardContent className="p-0">
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <p style={{
                                    ...
                                    Customizable dashboard components for monitoring project progress, resource usage, and team productivity metrics.
                                </p>
                            </div>
<Button
    variant="outline"
    ...
    Download Manuals
                ...
                <div style={{ textAlign: 'center', marginTop: '3rem' }}>
                    <p style={{
                        ...
                        Need custom Matrix configuration or have questions about our production pipeline?
                    </p>
                    <Link href="/contact" className="btn-simple" style={{
                        padding: '0.75rem 2rem',
                        fontSize: '1.1rem',
